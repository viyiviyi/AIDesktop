...
export function BrowserApp(_props: BrowserAppProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{
        ...
        background: 'rgba(0,0,0,0.15)', borderBottom: '1px solid rgba(255,255,255,0.1)',
        flexShrink: 0,
      }}>
        <input
          type="text" value={url}
          ...
          placeholder="输入网址..."
          style={{
            flex: 1, padding: '6px 12px', borderRadius: 16, border: 'none',
        ...
        <button onClick={handleNavigate} style={{
          ...
          background: 'var(--accent-color)', color: 'white', cursor: 'pointer', fontSize: 13,
        }}>前往</button>
      </div>
      <iframe
        src={currentUrl}
